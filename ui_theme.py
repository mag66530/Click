...
def crosspost_legend() -> str:
    ...
    items = (
        ...
        ("live", "✓", "уже вышло"),
        # Видео и прочее Click не формирует: значок в строке иначе читается
        # как непонятная закорючка без объяснения. Дзена это больше не
        # касается – его статьи Click ставит сам.

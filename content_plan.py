...
#
# SUPPORTED – то, что Click формирует САМ. Телеграма здесь пока нет намеренно
# (13.08.2026, по решению заказчицы): отложки у бота нет, время держал сам
# Click, и в час выхода он публиковал пост – а в разделе при этом писал
# «отправит Click в час выхода» и потом «вышло», хотя выходило не то и не
# так. Пока Телеграм не сделан по-настоящему, честнее показывать его как
# «публикуется вручную» и не трогать вовсе. Разбор реестра Телеграм

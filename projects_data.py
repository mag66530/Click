...
"MPE": """Напиши ответ на отзыв от лица компании по продаже металлопроката Метпромэнерго. Тон – деловой, уважительный, живой; предложения логично и естественно связаны между собой.
Текст отзыва: [вставить отзыв] Автор отзыва: [имя]
...
2. Основная часть – РОВНО ТРИ предложения в такой последовательности:
   • Предложение 1: перефразируй детали отзыва профессиональным деловым языком металлоторговли и логистики, не копируя слова клиента. Примеры замены: «машину подали вовремя» → «оперативная подача транспорта»; «документы были готовы» → «своевременная подготовка документов»; «довольны качеством и доставкой» → «высоко оценили качество продукции и чёткое соблюдение сроков».
   • Предложение 2: вырази позицию компании – понимание ситуации клиента, ценность этого для него, или пожелание дальнейшего сотрудничества. Должно логично вытекать из первого.
...
Рады, что вы оценили оперативную подачу транспорта и своевременную подготовку документов при поставке бериллия. Мы прекрасно понимаем, как важна каждая минута при разгрузке, и всегда стремимся беречь время и бюджет наших клиентов. Наш ассортимент закрывает большинство потребностей клиентов: цветной металл, нержавейка, сортовой и листовой прокат, трубная продукция, арматура.
...
Приятно, что вы высоко оценили нашу работу в сравнении с другими поставщиками, а также остались довольны качеством ниобия и быстрой доставкой. Будем рады новому долгосрочному и плодотворному сотрудничеству! Наш ассортимент закрывает большинство потребностей клиентов: цветной металл, нержавейка, сортовой и листовой прокат, трубная продукция, арматура.

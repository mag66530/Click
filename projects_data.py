...
в ответе быть не должно. Тон простой и тёплый, без канцелярита.
...
отзыва, а не общими словами «оценили качество».
...
строка с рекомендацией; во втором и третьем рекомендации нет – там просто
«Спасибо за отзыв!».

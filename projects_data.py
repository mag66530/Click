...
"MPE": """Напиши ответ на отзыв от лица компании по продаже металлопроката Метпромэнерго. Тон – деловой, уважительный, предложения хорошо связаны между собой.
Текст отзыва: [вставить отзыв] Автор отзыва: [имя]
Структура – строго 3 абзаца:
1. Обращение по имени + краткая благодарность (одно предложение). Пример: «Иван, спасибо за отзыв!»
2. Основная часть (2–3 предложения): переформулируй своими словами то, что клиент отметил в отзыве (не копируй дословно), покажи понимание ситуации или важности для клиента, затем органично впиши фразу про ассортимент: «Ассортимент закрывает большинство потребностей клиентов: цветной металл, нержавейка, сортовой и листовой прокат, трубная продукция, арматура.»
...
Примеры готовых ответов – на ДРУГИЕ отзывы, приведены как образец тона и структуры, дословно не копировать:

Пример 1:
Иван, спасибо за отзыв!

Рады, что вы оценили оперативную подачу транспорта и своевременную подготовку документов при поставке бериллия. Мы прекрасно понимаем, как важна каждая минута при разгрузке, и всегда стремимся беречь время и бюджет наших клиентов. Ассортимент закрывает большинство потребностей клиентов: цветной металл, нержавейка, сортовой и листовой прокат, трубная продукция, арматура.
...
REVIEW_ASSORTMENT = {
    ...
    "MPE": "Ассортимент закрывает большинство потребностей клиентов: цветной металл, "

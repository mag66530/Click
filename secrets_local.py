...
def get(name: str) -> str:
    """Значение из файла настроек этой машины. Пусто – не вписано.

    Общие для всей команды значения (например, прокси Телеграма) в код НЕ
    зашиваем: они лежат в общем хранилище (ветка click-data через repo_store)
    и читаются оттуда в нужном месте – так пароль не попадает в исходники и в
    рассылаемые zip-архивы."""

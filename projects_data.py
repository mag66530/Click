...
"APS": """Напиши краткий и лаконичный ответ на отзыв от лица компании по продаже металлопроката Авиапромсталь.
Текст отзыва: [вставить отзыв] Автор отзыва: [имя]
Структура — строго 4 абзаца, официальный деловой тон:
Обращение: «Уважаемый(ая) [имя]!»
Абзац благодарности — коротко, по-деловому, без эмоций, отметить факт отзыва
Абзац про ассортимент: «Полный набор металлопродукции: цветной прокат, нержавейка, сортовые и листовые виды, трубы, арматура — собираем и отгружаем без задержек»
Закрытие: «С уважением, команда Авиапромсталь.»
Объём: каждый абзац — 2 предложения, максимально сдержанно, без разговорных оборотов.
Ограничения: «команда» — 1 раз; не использовать «база», «металлобаза», «магазин», «склад», «металлопрокатный центр»; «Авиапромсталь» — 1 раз (только в закрытии).

Пример готового ответа — на ДРУГОЙ отзыв, приведён как образец тона и структуры, дословно не копировать:
Уважаемая Анастасия!
Благодарим за отзыв и рекомендацию. Отмечаем, что оперативная связь и своевременная доставка — приоритетные направления нашей работы.
...
Ограничения:
Не использовать «Уважаемый(ая) [имя]»
